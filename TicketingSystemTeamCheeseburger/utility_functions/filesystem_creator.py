...
default_tickets_contents = {
    "tickets": [
        ...
        {
            "title":"Cannot purchase things from the cosmetics store",
            "submitting_user_index":"user_2",
            "priority":1,
            "nature":2,
            "content":"...",
            "status":"ongoing"
...
#Function for checking the user filesystem.
    ...
    users_directory_files = [logs_file_employee, logs_file_user]
    users_directory_directories = [logs_directory, logs_directory_employee, logs_directory_user]
